...
HOMEPAGE_URL: str = "https://zenodo.org/record/5153251#.YlAixn9Bzmg"
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 5534984
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/annotated-quantitative-phase-microscopy-cell-dataset"
